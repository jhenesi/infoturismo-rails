...
angular.module('infoturismoApp').directive('loginDialog', ['blockui', 'icons', 'labels', 'Authentication', 'AuthEvents', '$rootScope', '$route', function (blockui, icons, labels, Authentication, AuthEvents, $rootScope, $route) {
	return {
		scope: {
            show: '='
        },
