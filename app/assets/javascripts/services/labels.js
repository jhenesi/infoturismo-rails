...
angular.module('infoturismoApp').service('labels',['$sce', function($sce) {
	return {
		...
		transporteDisponibilidadEstacionamiento: $sce.trustAsHtml('Disponibilidad de estacionamiento'),

	 	//Labels Costo
	 	costo: $sce.trustAsHtml('Costo'),
	 	costoGeneral: $sce.trustAsHtml('General'),
	 	costoTransportacion: $sce.trustAsHtml('Transportacion'),
	 	costoHospedaje: $sce.trustAsHtml('Hospedaje'),
	 	costoTransporte: $sce.trustAsHtml('Transporte'),
	 	...
	 	experienciaViajeActividades: $sce.trustAsHtml('Variedad de actividades recreativas'),
 		experienciaViajeEmocion: $sce.trustAsHtml('Emocion de visitar este sitio'),
